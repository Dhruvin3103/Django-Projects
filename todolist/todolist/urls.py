...
admin.site.site_title ="UnicodeLP"
admin.site.site_header ="UnicodeLP"
...
urlpatterns = [
    ...
    path('retriveT/<str:id>',views.retrive,name='retrive'),
    path('retriveL/<str:id>/<str:id1>',views.retriveL,name='retriveL'),
    path('checkbox/<str:id>',views.checkbox,name='checkbox'),
    path('checkbox1/<str:id>',views.checkbox1,name='checkbox1'),
    path('checkbox2/<str:id>',views.checkbox2,name='checkbox2'),
